...
var _user$project$Spacebrew_Spacebrew$mockMultipleClientConfig = '\n[{\n    \"config\": {\n        \"name\": \"PLAYER 1\",\n        \"description\": \"PLAYER 1 client \",\n        \"subscribe\": {\n            \"messages\": [{\n                \"name\": \"control\",\n                \"type\": \"string\"\n            }]\n        },\n        \"publish\": {\n            \"messages\": [{\n                \"name\": \"player1\",\n                \"type\": \"string\",\n                \"default\": \"\"\n            }]\n        },\n        \"remoteAddress\": \"127.0.0.1\"\n    }\n}\n, {\n    \"config\": {\n        \"name\": \"PLAYER 1\",\n        \"description\": \"PLAYER 1 client \",\n        \"subscribe\": {\n            \"messages\": [{\n                \"name\": \"control\",\n                \"type\": \"string\"\n            }]\n        },\n        \"publish\": {\n            \"messages\": [{\n                \"name\": \"player1\",\n                \"type\": \"string\",\n                \"default\": \"\"\n            }]\n        },\n        \"remoteAddress\": \"127.0.0.1\"\n    }\n}]\n';
var _user$project$Spacebrew_Spacebrew$mockClientConfig = '\n{\n    \"config\": {\n        \"name\": \"PLAYER 2\",\n        \"description\": \"PLAYER 2 client \",\n        \"subscribe\": {\n            \"messages\": [{\n                \"name\": \"control\",\n                \"type\": \"string\"\n            }]\n        },\n        \"publish\": {\n            \"messages\": [{\n                \"name\": \"player2\",\n                \"type\": \"string\",\n                \"default\": \"\"\n            }]\n        },\n        \"remoteAddress\": \"127.0.0.1\"\n    },\n    \"targetType\": \"admin\"\n}\n';
var _user$project$Spacebrew_Spacebrew$mockAdminConfig = '\n{ \"admin\" : true\n ,\"no_msgs\" : true\n }\n';
var _user$project$Spacebrew_Spacebrew$clientName = function (config) {
	return function (_) {
		return _.name;
	}(
		function (_) {
...
var _user$project$Spacebrew_Spacebrew$handleFlag = function (flag) {
	var _p0 = flag;
	if (_p0.ctor === 'ClientFlag') {
		return _user$project$Spacebrew_Spacebrew$clientName(_p0._0);
	} else {
		return 'unhandled flag';
	}
};
var _user$project$Spacebrew_Spacebrew$encodeAdminConfig = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'admin',
				_1: _elm_lang$core$Json_Encode$bool(record.admin)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'no_msgs',
					_1: _elm_lang$core$Json_Encode$bool(record.no_msgs)
				},
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Spacebrew_Spacebrew$encodeChannel = function (channel) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'name',
				_1: _elm_lang$core$Json_Encode$string(channel.name)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'type',
					_1: _elm_lang$core$Json_Encode$string(channel.channelType)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'default',
						_1: _elm_lang$core$Json_Encode$string(channel.$default)
					},
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$Spacebrew_Spacebrew$ClientConfigMsg = function (a) {
	return {config: a};
};
var _user$project$Spacebrew_Spacebrew$ClientConfigMsgDetail = F4(
	function (a, b, c, d) {
		return {name: a, description: b, subscribe: c, publish: d};
	});
var _user$project$Spacebrew_Spacebrew$ClientConfig = function (a) {
	return {config: a};
};
var _user$project$Spacebrew_Spacebrew$ClientConfigDetail = F5(
	function (a, b, c, d, e) {
		return {name: a, description: b, subscribe: c, publish: d, remoteAddress: e};
	});
var _user$project$Spacebrew_Spacebrew$Channel = F3(
	function (a, b, c) {
		return {name: a, channelType: b, $default: c};
	});
var _user$project$Spacebrew_Spacebrew$subscribeToStringChannel = F2(
	function (name, $default) {
		return A2(
			_elm_lang$core$Json_Encode$encode,
			0,
			_user$project$Spacebrew_Spacebrew$encodeChannel(
				A3(_user$project$Spacebrew_Spacebrew$Channel, name, 'string', $default)));
	});
var _user$project$Spacebrew_Spacebrew$AdminRecord = F2(
	function (a, b) {
		return {admin: a, no_msgs: b};
	});
var _user$project$Spacebrew_Spacebrew$adminWithMsg = A2(
	_elm_lang$core$Json_Encode$encode,
	0,
	_user$project$Spacebrew_Spacebrew$encodeAdminConfig(
		A2(_user$project$Spacebrew_Spacebrew$AdminRecord, true, true)));
var _user$project$Spacebrew_Spacebrew$SubChannel = F2(
	function (a, b) {
		return {ctor: 'SubChannel', _0: a, _1: b};
	});
var _user$project$Spacebrew_Spacebrew$decodeSubChannel = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Spacebrew_Spacebrew$SubChannel,
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'type', _elm_lang$core$Json_Decode$string));
var _user$project$Spacebrew_Spacebrew$decodeSubMessages = A2(
	_elm_lang$core$Json_Decode$field,
	'messages',
	_elm_lang$core$Json_Decode$list(_user$project$Spacebrew_Spacebrew$decodeSubChannel));
var _user$project$Spacebrew_Spacebrew$PubChannel = F3(
	function (a, b, c) {
		return {ctor: 'PubChannel', _0: a, _1: b, _2: c};
	});
var _user$project$Spacebrew_Spacebrew$decodePubChannel = A4(
	_elm_lang$core$Json_Decode$map3,
	_user$project$Spacebrew_Spacebrew$PubChannel,
	A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'type', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'default', _elm_lang$core$Json_Decode$string));
var _user$project$Spacebrew_Spacebrew$decodePubMessages = A2(
	_elm_lang$core$Json_Decode$field,
	'messages',
	_elm_lang$core$Json_Decode$list(_user$project$Spacebrew_Spacebrew$decodePubChannel));
var _user$project$Spacebrew_Spacebrew$clientConfigDecoder = function () {
	var configuration = A6(
		_elm_lang$core$Json_Decode$map5,
		_user$project$Spacebrew_Spacebrew$ClientConfigDetail,
		A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'description', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'subscribe', _user$project$Spacebrew_Spacebrew$decodeSubMessages),
		A2(_elm_lang$core$Json_Decode$field, 'publish', _user$project$Spacebrew_Spacebrew$decodePubMessages),
		A2(_elm_lang$core$Json_Decode$field, 'remoteAddress', _elm_lang$core$Json_Decode$string));
	return A2(
		_elm_lang$core$Json_Decode$map,
		_user$project$Spacebrew_Spacebrew$ClientConfig,
		A2(_elm_lang$core$Json_Decode$field, 'config', configuration));
}();
var _user$project$Spacebrew_Spacebrew$RangeValue = function (a) {
	return {ctor: 'RangeValue', _0: a};
};
var _user$project$Spacebrew_Spacebrew$BooleanValue = function (a) {
	return {ctor: 'BooleanValue', _0: a};
};
var _user$project$Spacebrew_Spacebrew$StringValue = function (a) {
	return {ctor: 'StringValue', _0: a};
};
var _user$project$Spacebrew_Spacebrew$Unknown = function (a) {
	return {ctor: 'Unknown', _0: a};
};
var _user$project$Spacebrew_Spacebrew$MultipleClientFlag = function (a) {
	return {ctor: 'MultipleClientFlag', _0: a};
};
var _user$project$Spacebrew_Spacebrew$ClientFlag = function (a) {
	return {ctor: 'ClientFlag', _0: a};
};
var _user$project$Spacebrew_Spacebrew$clientDecoder = A2(_elm_lang$core$Json_Decode$map, _user$project$Spacebrew_Spacebrew$ClientFlag, _user$project$Spacebrew_Spacebrew$clientConfigDecoder);
var _user$project$Spacebrew_Spacebrew$AdminConfig = function (a) {
	return {ctor: 'AdminConfig', _0: a};
};
var _user$project$Spacebrew_Spacebrew$adminConfigDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$Spacebrew_Spacebrew$AdminConfig,
	A3(
		_elm_lang$core$Json_Decode$map2,
		_user$project$Spacebrew_Spacebrew$AdminRecord,
		A2(_elm_lang$core$Json_Decode$field, 'admin', _elm_lang$core$Json_Decode$bool),
		A2(_elm_lang$core$Json_Decode$field, 'no_msgs', _elm_lang$core$Json_Decode$bool)));
var _user$project$Spacebrew_Spacebrew$decode = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
		_0: _user$project$Spacebrew_Spacebrew$adminConfigDecoder,
		_1: {
			ctor: '::',
			_0: _user$project$Spacebrew_Spacebrew$clientDecoder,
			_1: {
				ctor: '::',
				_0: _elm_lang$core$Json_Decode$fail('Could not decode value'),
				_1: {ctor: '[]'}
			}
		}
	});
var _user$project$Spacebrew_Spacebrew$ClientMsg = function (a) {
	return {ctor: 'ClientMsg', _0: a};
};
var _user$project$Spacebrew_Spacebrew$clientConfigMsgDecoder = function () {
	var configuration = A5(
		_elm_lang$core$Json_Decode$map4,
		_user$project$Spacebrew_Spacebrew$ClientConfigMsgDetail,
		A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'description', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'subscribe', _user$project$Spacebrew_Spacebrew$decodeSubMessages),
		A2(_elm_lang$core$Json_Decode$field, 'publish', _user$project$Spacebrew_Spacebrew$decodePubMessages));
	var clientMsg = A2(
		_elm_lang$core$Json_Decode$map,
		_user$project$Spacebrew_Spacebrew$ClientConfigMsg,
		A2(_elm_lang$core$Json_Decode$field, 'config', configuration));
	return A2(_elm_lang$core$Json_Decode$map, _user$project$Spacebrew_Spacebrew$ClientMsg, clientMsg);
}();
var _user$project$Spacebrew_Spacebrew$test = A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Spacebrew_Spacebrew$clientConfigMsgDecoder, _user$project$Spacebrew_Spacebrew$mockClientConfig);
var _user$project$Spacebrew_Spacebrew$Send = F2(
	function (a, b) {
		return {ctor: 'Send', _0: a, _1: b};
	});
var _user$project$Spacebrew_Spacebrew$PubStringChannel = F2(
	function (a, b) {
		return {ctor: 'PubStringChannel', _0: a, _1: b};
	});
var _user$project$Spacebrew_Spacebrew$SubStringChannel = function (a) {
	return {ctor: 'SubStringChannel', _0: a};
};
var _user$project$Spacebrew_Spacebrew$subMsgDecoder = A2(
	_elm_lang$core$Json_Decode$map,
	_user$project$Spacebrew_Spacebrew$SubStringChannel,
	A2(_elm_lang$core$Json_Decode$field, 'message', _elm_lang$core$Json_Decode$string));
var _user$project$Spacebrew_Spacebrew$AdminMsg = function (a) {
	return {ctor: 'AdminMsg', _0: a};
};

var _user$project$Client$decodeClientMessage = _elm_lang$core$Json_Decode$decodeValue(
	_elm_lang$core$Json_Decode$oneOf(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Json_Decode$field, 'messages', _elm_lang$core$Json_Decode$string),
			_1: {ctor: '[]'}
		}));
var _user$project$Client$handleMessage = function (msg) {
	var _p0 = msg;
	if (_p0.ctor === 'Ok') {
		return _p0._0;
	} else {
		return A2(_elm_lang$core$Basics_ops['++'], 'bad message: ', _p0._0);
	}
};
var _user$project$Client$init = {
	ctor: '_Tuple2',
	_0: {
		messages: {ctor: '[]'},
		clientId: 'foo123',
...
var _user$project$Client$messageReceived = _elm_lang$core$Native_Platform.outgoingPort(
	'messageReceived',
	function (v) {
		return v;
	});
var _user$project$Client$log = _elm_lang$core$Native_Platform.outgoingPort(
	'log',
	function (v) {
		return v;
	});
			...
			return {
				...
				_0: _elm_lang$core$Native_Utils.update(
					model,
					{
						messages: {
							ctor: '::',
							_0: _user$project$Client$handleMessage(_p2),
							_1: model.messages
						}
					}),
				_1: _user$project$Client$log(
					A2(
						_elm_lang$core$Basics_ops['++'],
						' logging from elm: ',
						_user$project$Client$handleMessage(_p2)))
			};
		} else {
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: A2(_elm_lang$websocket$WebSocket$send, model.server, _p1._0)
			};
		}
	});
var _user$project$Client$sendMessage = _elm_lang$core$Native_Platform.incomingPort('sendMessage', _elm_lang$core$Json_Decode$value);
var _user$project$Client$Model = F3(
	function (a, b, c) {
		return {messages: a, clientId: b, server: c};
	});
var _user$project$Client$Connect = function (a) {
	return {ctor: 'Connect', _0: a};
};
var _user$project$Client$Message = function (a) {
	return {ctor: 'Message', _0: a};
};
var _user$project$Client$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Client$sendMessage(
				function (_p3) {
					return _user$project$Client$Message(
						_user$project$Client$decodeClientMessage(_p3));
				}),
			_1: {ctor: '[]'}
		});
};
var _user$project$Client$main = _elm_lang$core$Platform$program(
	{init: _user$project$Client$init, update: _user$project$Client$update, subscriptions: _user$project$Client$subscriptions})();
